...
<head>
    ...
    <title>Admin Dashboard - E-Learning MTs Hakadua</title>
    <!-- General CSS Files -->
                        ...
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <p class="card-text">Klik tombol dibawah untuk menambah materi . Materi yang
                                    ditambahkan, akan langsung terupload di database E-Learning MTs Hakadua. Dan para siswa bisa
                                    segera belajar! </p>
...
echo $data['user']['username'];
?>!</h1>
                                <p class="lead">Di halaman admin E-Learning MTs Hakadua - Web Edukasi Sekolah Menengah Kejuruan Satu
                                    Ciamis.<br></p>
                                <div class="mt-4">
