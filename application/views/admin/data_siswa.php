...
<head>
    ...
    <title>Data Siswa - E-Learning MTs Hakadua</title>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Siswa E-Learning MTs Hakadua</h2>
                                <hr>
                                <p class="card-text"> Jumlah Siswa yang terdaftar di E-Learning MTs Hakadua sekarang adalah <span
