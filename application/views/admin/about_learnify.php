...
<head>
    ...
    <title>Tentang Developer - E-Learning MTs Hakadua</title>
    <!-- General CSS Files -->
...
?></div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - E-Learning MTs Hakadua</div>
                    ...
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="<?=base_url('admin')?>"
                                ...
                                E-Learning MTs Hakadua</a>
                        </divE-Learning MTs Hakadua                    </div>
                ...
                <section class="section">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang E-Learning MTs Hakadua</h2>
                                <hr>
                                <p class="card-text">Web Edukasi Open Source yang dibuat
                                    ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan
                                    kapan saja. </p>
                                <a href="#" class="btn btn-primary">Github
                                    Project</a>
                            </div>
                        </div>
                    </div>
