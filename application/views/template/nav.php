...
<head>
    ...
    <title>E - Learning MTs Hakadua</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="tel:+6285724710533">+6285724710533</a>
                    <a class="dn_btn" href="mailto:info@excellenz.id">info@excellenz.id</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" ><img
