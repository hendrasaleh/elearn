...
echo $data['user']['nama'];
?> - E-Learning MTs Hakadua Student Page</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400"
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <p>Hello Students! , Ini merupakan halaman mapel E-Learning MTs Hakadua! Silahkan pilih mapel yang akan kamu
                        akses
                        dan video serta materi siap disaksikan! Selamat belajar ya students!</p>
                    <hr>
...
$data['user'] = $this->db->get_where('siswa', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nama'];
?> - E-Learning MTs Hakadua Students</h3>
