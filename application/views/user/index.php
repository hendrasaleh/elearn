            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h3 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down"
                        ...
                        di E-Learning MTs Hakadua <span style="font-size: 40px;">👋🏻
                        </span> </h3>
                    <p>Hello Students! , Ini merupakan halaman utama E-Learning MTs Hakadua ! Silahkan pilih kelas yang akan kamu
                        akses
