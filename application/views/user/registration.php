...
<head>
    ...
    <title>E-Learning MTs Hakadua - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="tel:+62232613808">(0232) 613808</a>
                    <a class="dn_btn" href="mailto:info@mtshakadua.sch.id">info@mtshakadua.sch.id</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
